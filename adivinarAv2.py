...
def index():
    iniciar_juego()
    mensaje = "¡Nuevo juego iniciado! Ingresa tu numero."
...
def adivinar():
    ...
    # Calcular diferencia
    diferencia = abs(numero_a_adivinar - intento_usuario)
